///  LORA.h - Library for LORA1276/1278 
///  Copyright (c) 2015 NiceRF.  All right reserved.  
///  @version 1.0  
///  This library is suit for LORQ1276/1278 in lora mode
///  please make sure the supply of you board is UNDER 3.3V!!
///  Or the module will be destory!!
///
///  The configuration of both module should be same.
///  The default configuration is RF frequency=434Mhz,bandwidth = 500Hz, 
...
public:
	...
	LORA(uint8_t NSSPin = 10, uint8_t NRESETPin = 9);
...
protected:
	...
	bool config();
	///  Set antenna switch
	///  @param	 mode	  0 other,1 rx mode,2 tx mode
	void setAntSwitch(uint8_t mode);
...
private:
	...
	uint8_t _NRESETPin;
	/// txEnPin 	output pin,tx Antenna Switch
	uint8_t _txEnPin;
	/// rxEnPin 	output pin,rx Antenna Switch
	uint8_t _rxEnPin;
	/// header mode
	uint8_t _headerMode;
